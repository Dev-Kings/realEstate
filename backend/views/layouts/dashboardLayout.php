...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">RANES ENTERPRISE</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <hr>
          <li class="nav-item">
            <a href="<?= \yii\helpers\Url::to(['/lands/index']) ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?= \yii\helpers\Url::to(['/property/index']) ?>" class="nav-link">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="<?= \yii\helpers\Url::to(['/lands/index']) ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021-2022 <a href="https://kingasiadavid41.wixsite.com/website">Design by David King'asia</a>.</strong>
    All rights reserved.

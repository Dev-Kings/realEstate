        ...
        'attributes' => [
            ...
            'property_price',
             [
                 ...
                 //'value' => Yii::getAlias('@web').'/'.$dataProvider->models[0]->picture,
                 //'value' => Yii::getAlias('/../advanced/frontend/web').'/'.$model->picture, ['alt'=>'some', 'class'=>'thing', 'height'=>'1000px', 'width'=>'1000px'], ['site/zoom'],
